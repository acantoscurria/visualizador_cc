...
class MatricComunSecundaria(models.Model):
    ...
    nombre_secc = models.CharField(max_length=-1, blank=True, null=True)
    tipo_secc = models.CharField(max_length=-1, blank=True, null=True)
    total = models.IntegerField(blank=True, null=True)
    total_var = models.IntegerField(blank=True, null=True)
    nivel = models.CharField(max_length=-1, blank=True, null=True)
    grado_año = models.CharField(max_length=-1, blank=True, null=True)
    ...
    nom_est = models.CharField(max_length=-1, blank=True, null=True)
    nro_est = models.CharField(max_length=-1, blank=True, null=True)
    anio_creac_establec = models.CharField(max_length=-1, blank=True, null=True)
    fecha_creac_establec = models.CharField(max_length=-1, blank=True, null=True)
    region = models.CharField(max_length=-1, blank=True, null=True)
    udt = models.CharField(max_length=-1, blank=True, null=True)
    cui = models.CharField(max_length=-1, blank=True, null=True)
    cua = models.CharField(max_length=-1, blank=True, null=True)
    cuof = models.CharField(max_length=-1, blank=True, null=True)
    sector = models.CharField(max_length=-1, blank=True, null=True)
    ambito = models.CharField(max_length=-1, blank=True, null=True)
    ref_loc = models.CharField(max_length=-1, blank=True, null=True)
    ...
    cod_postal = models.CharField(max_length=-1, blank=True, null=True)
    categoria = models.CharField(max_length=-1, blank=True, null=True)
    estado_est = models.CharField(max_length=-1, blank=True, null=True)
    estado_loc = models.CharField(max_length=-1, blank=True, null=True)
    telefono_cod_area = models.CharField(max_length=-1, blank=True, null=True)
    telefono_nro = models.CharField(max_length=-1, blank=True, null=True)
    per_funcionamiento = models.CharField(max_length=-1, blank=True, null=True)
    email_loc = models.CharField(max_length=-1, blank=True, null=True)
